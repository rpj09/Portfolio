...
github_lottie = load_lottie("https://assets9.lottiefiles.com/packages/lf20_5EI9XwtboP.json")
...
with st.container():
    ...
    with st.container():
        col1, col2, col3 = st.columns([1, 1, 1])
        with col1:
            st.image("https://static.djangoproject.com/img/logos/django-logo-positive.png",width=70)
